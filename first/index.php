...
if(isset($_POST['name'])){
	...
	$sql = "INSERT INTO `trip`.`trip` (`name`, `age`, `gender`, `email`, `phone`, `other`, `dt`) VALUES ('$name', '$age', '$gender', '$email', '$phone', '$desc', CURRENT_DATE())";
...
<body>
	<img class = "bg" src="bg.jpg" alt = "Paris">

	<div class="container">
		<h1>Get started with the trip to Paris</h1>
		<p>Enter your details to confirm the participation in this trip</p>

		<?php

		if($insert == true){
		echo "<p class='submitMsg'>Thankyou for submitting the information</p>";
	    }
		?>
